 ...
 *  Software Licence Version 1, to describe a Pytohn extension.       *
 *                                                                    *
...
/*******************************************************************************
* From the original clipper source:                                            *
*                                                                              *
...
short parse_points_set(PyObject *pointsset, Path &paths, double scaling)
{
...
static PyObject* inside(PyObject *self, PyObject *args)
{
  ...
  if (parse_points_set(pts, points, scaling) != 0) return NULL;
...
offseting and it is used for boolean operations in the context of *gdspy*.";

static PyMethodDef clipperMethods[] = {
  {"clip", clip, METH_VARARGS,\
"Perform a boolean operation (clipping) btween 2 sets of polygons.\n\n\
Parameters\n\
----------\n\
...
"Perform a point inside polygons test between each point in a set of vertices and a set of polygons.\n\n\
Parameters\n\
----------\n\
pts : list of array-like[N][2]\n\
    List of points. Each point is an array-like[N][2]\n\
    object with the coordinates of the point.\n\
poly : list of array-like[N][2]\n\
    List of polygons. Each polygon is an array-like[N][2]\n\
    object with the coordinates of the vertices of the polygon.\n\
groupsize : integer\n\
